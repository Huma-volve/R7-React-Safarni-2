      ...
      },
      {
          ...
          icon: (
              <svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                      d="M10.75 7.625V4.5C10.75 2.42893 9.07107 0.75 7 0.75C4.92893 0.75 3.25 2.42893 3.25 4.5V7.625M2.625 17H11.375C12.4105 17 13.25 16.1605 13.25 15.125V9.5C13.25 8.46447 12.4105 7.625 11.375 7.625H2.625C1.58947 7.625 0.75 8.46447 0.75 9.5V15.125C0.75 16.1605 1.58947 17 2.625 17Z"
                      stroke="#AFAFAF"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"
  ...
  return (
      <div className="max-w-[1240px] mx-auto">
          ...
          <div className="flex gap-14 mt-[20px]">
              <div className="w-[500px] h-[700px] bg-[#F4F4F4]  rounded-[30px]">
                  <img src="../../../public/images/hand.png" alt="" className="w-full h-full object-contain mix-blend-multiply" />
              </div>
                      ...
                      <div className="">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path
                                  fill-rule="evenodd"
                                  clip-rule="evenodd"
                                  d="M0 9.75C0 4.36522 4.36522 0 9.75 0C15.1348 0 19.5 4.36522 19.5 9.75C19.5 15.1348 15.1348 19.5 9.75 19.5C4.36522 19.5 0 15.1348 0 9.75ZM13.3603 7.93593C13.6011 7.59887 13.523 7.13046 13.1859 6.8897C12.8489 6.64894 12.3805 6.72701 12.1397 7.06407L8.9043 11.5936L7.28033 9.96967C6.98744 9.67678 6.51256 9.67678 6.21967 9.96967C5.92678 10.2626 5.92678 10.7374 6.21967 11.0303L8.46967 13.2803C8.62556 13.4362 8.84215 13.5156 9.06186 13.4974C9.28157 13.4793 9.48216 13.3653 9.6103 13.1859L13.3603 7.93593Z"
                                  fill="#9CA3AF"
                              />
                          </svg>
                      </div>
                      <div className="text-[14px] font-normal texr-[#6B7280]">must be at least 8 characters</div>
                  </div>
                  <div className="flex items-center gap-[16px]">
                      <div className="">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className="text-[14px] font-normal texr-[#6B7280]">must contain one special character</div>
                  </div>
        ...
        transition duration-200 hover:bg-[#E6F4FF] hover:scale-[1.03] cursor-pointer">
                  ...
                  <div className="text-[18px] font-medium text-[#111928] text-center">
                      Already have an account?<span className="text-[18px] font-semibold text-[#1E429F] cursor-pointer"> sign In</span>
                  </div>
              </div>
          </div>
      </div>
